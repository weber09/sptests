...
/*         public static void main(String args[]) {
  ...
  static final public SPCompilationUnit compilationUnit()  throws ParseException
  {
    ...
    ArrayList<SPVariableDeclarator> variables = VariableInitializer();
...
/*VARIABLES DECLARATION BLOCK*/
  static final public
  ArrayList<SPVariableDeclarator> VariableInitializer() throws ParseException {
    jj_consume_token(VAR);
    return VariableDeclarations();
  }

  static final public ArrayList<SPVariableDeclarator> VariableDeclarations() throws ParseException {
  ...
  static final public SPVariableDeclarator Name() throws ParseException {
    int line;
    String name;
...
/*STATEMENTS*/
  ...
  static final public SPStatement StatementExpression() throws ParseException {

    int line = 0;
    jj_consume_token(IDENTIFIER);
    line = token.beginLine;
    SPExpression lhs = new SPVariable(token.beginLine, token.image);
  ...
  static final public SPAssignment AssignmentOperator() throws ParseException {
  ...
  static final public SPExpression ConditionalOrExpression() throws ParseException {
  ...
  static final public SPExpression ConditionalAndExpression() throws ParseException {
    SPExpression lhs, rhs;
  ...
  static final public SPExpression EqualityExpression() throws ParseException {
    SPExpression lhs = null, rhs = null;
  ...
  static final public SPExpression RelationalExpression() throws ParseException {
    SPExpression lhs = null, rhs = null;
  ...
  static final public SPExpression AdditiveExpression() throws ParseException {
    SPExpression lhs, rhs;
  ...
  static final public SPExpression MultiplicativeExpression() throws ParseException {
    int line;
    SPExpression lhs, rhs;
  ...
  static final public SPExpression PowerExpression() throws ParseException {
    SPExpression expr, unaryExpr;
  ...
  static final public SPExpression UnaryExpression() throws ParseException {
  ...
  static final public SPExpression PrimaryExpression() throws ParseException {
    SPExpression expr;
  ...
  static final public SPExpression Literal() throws ParseException {
  ...
  static final public SPExpression BooleanLiteral() throws ParseException {
    SPExpression expr;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VERDADEIRO:{
